<template>
  <el-form :inline="true" class="demo-form-inline" label-width="100px" label-position="right">
    ...
    <el-form-item label="销售订单类型">
      <el-select v-model="user.xsddlx" placeholder="---请选择---">
        <el-option label="000" value="0"></el-option>
        <el-option label="001" value="1"></el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="客户订单">
      <el-input placeholder v-model="user.khdd" clearable></el-input>
    </el-form-item>
    <br />
    ...
    <el-form-item label="单况">
      <el-select v-model="user.dk" placeholder="---请选择---">
    ...
    <el-tabs v-model="activeName1">
      <el-tab-pane label="内容" name="first1">
        <el-table :data="tableData" style="width: 100%" max-height="250">
          ...
          <el-table-column label="预出库日" width="80"></el-table-column>
          <el-table-column label="未出数量" width="80"></el-table-column>
          ...
          <el-table-column label="生产" width="80"></el-table-column>
          <el-table-column label="（排程单号）" width="80"></el-table-column>
          <el-table-column label="已产生数量" width="80"></el-table-column>
        </el-table>
